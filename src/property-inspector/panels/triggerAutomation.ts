...
export class TriggerAutomationPIAction extends ActionPI {
    ...
    override setUp(): void {
        super.setUp();
        logMessage("Injecting trigger automation parameters");
        ...
        wrapper.insertAdjacentHTML(
            ...
            `
                <div class="sdpi-item">
                    <div class="sdpi-item-label">Automation</div>
    ...
    override update(homeAssistantCache: HomeAssistantCache): void {
        ...
        ActionPI.populateEntityOptions(entityIdSelector, "automation", homeAssistantCache);
        if (this.settings.entityId) {

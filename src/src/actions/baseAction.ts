...
export abstract class BaseAction<TSettings extends ActionSettings = ActionSettings> extends SingletonAction<TSettings> {
    ...
    constructor() {
        super();
        this.unsubscribeFromCache = cacheManager.subscribe((cache) => this.broadcastCache(cache));
    }
    ...
    override async onPropertyInspectorDidAppear(ev: PropertyInspectorDidAppearEvent<TSettings>): Promise<void> {
    ...
    protected handleWillAppear(_ev: WillAppearEvent<TSettings>): void | Promise<void> {
        // optional override
    }

    protected handleWillDisappear(_ev: WillDisappearEvent<TSettings>): void | Promise<void> {
        // optional override
    }

    protected handleSettingsChanged(_ev: DidReceiveSettingsEvent<TSettings>): void | Promise<void> {
        // optional override
    }
